...
public class AdminForm extends JFrame {
	...
	public AdminForm() {
		...
		JButton btnDelete = new JButton("Quản lý phòng");
		...
		btnDelete.setFont(new Font("Roboto", Font.BOLD, 22));
		btnDelete.setBounds(229, 227, 383, 256);
		contentPane.add(btnDelete);
		
		JButton btnNewButton_2 = new JButton("Quản lý món ăn");
		...
		btnBack.setFont(new Font("Roboto", Font.BOLD, 22));
