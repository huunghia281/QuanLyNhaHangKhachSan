...
public class secondPage extends JFrame {
	...
	public secondPage() {
		...
		comboBox.setFont(new Font("Roboto", Font.BOLD, 22));
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"Phòng", "Nhà hàng"}));
		comboBox.setBounds(53, 371, 408, 48);
		contentPane.add(comboBox);
		
		JButton btnNewButton = new JButton("  Khách Hàng");
		btnNewButton.setToolTipText("");
		btnNewButton.setFont(new Font("Roboto", Font.BOLD, 30));
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(comboBox.getSelectedItem()=="Nhà hàng")
				{	
		...
		JLabel lblFromSeasideTo = new JLabel("Nơi hạnh phúc nhất trên trái đất");
		lblFromSeasideTo.setForeground(new Color(240, 255, 255));
		lblFromSeasideTo.setFont(new Font("Times new roman", Font.BOLD | Font.ITALIC, 60));
